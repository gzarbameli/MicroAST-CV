...
tv_loss = TotalVariation().to(device="cpu")
frechet_loss = FrechetInceptionDistance(feature=64, normalize=True).to(device="cpu")
cosine_sim = nn.CosineSimilarity(dim=1, eps=1e-6).to(device="cpu")
l1_loss = nn.L1Loss()
